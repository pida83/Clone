...
enum CloneProject: String, CaseIterable {
    ...
    var target : [Target] {
        ...
        default :
            ...
            return makeProjectTarget(name: projectName, bundleID: bundleID, platform: platform, path: projectPath, dependencies: cases + [.rxSwift, .rxCocoa, .rxGesture, .rxRelay, .rxDataSources, .then, .snapKit, .swiftyJson, .toast, .alamofire, .googleGroup, .moya, .naverGroup, .realm])
        }
    }
